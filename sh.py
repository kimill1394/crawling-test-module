...
# 함수를 실행하는 부분!
# result = url_crawling(2, "http://www.ittoday.co.kr/news/articleList.html?sc_section_code=S1N11&amp;view_type=sm", "td[class=ArtList_Title]" )
...
result = url_crawling(3, "http://blog.naver.com/PostList.nhn?blogId=smashhit&from=postList&categoryNo=17", "div[class='se_doc_viewer se_body_wrap se_theme_transparent ']")

print(result)


#똑똑이 승현이가 넣어두라는 소스입니당 승현이 사랑해요~
